...
def parse_opt(known=False):
    ...
    parser.add_argument('--imgsz', '--img', '--img-size', nargs='+', type=int, default=[256, 256], help='image (h, w)')
    ...
    parser.add_argument('--iou-thres', type=float, default=0.2, help='TF.js NMS: IoU threshold')
